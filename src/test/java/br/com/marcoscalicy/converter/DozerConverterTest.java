...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        ...
        Assert.assertEquals("Addres Test0", output.getAdrdess());
    ...
    public void parseEntityListToVOListTest() {
        ...
        Assert.assertEquals("Addres Test0", outputZero.getAdrdess());
        ...
        Assert.assertEquals("Addres Test7", outputSeven.getAdrdess());
        ...
        Assert.assertEquals("Addres Test12", outputTwelve.getAdrdess());
